  ...
  processData(lang, function(time, lyrics){
	...
	Timer : function(callback,delay) {
		...
		displayEcho : function(data){
			console.log(data.response.biographies[0]);
				$("#insideTheFloater").html("<p>Artist Biography from Echonest</p><a href=\"#\" style=\"font-size: 13px;\">Read More  >></a><p style=\"font-size: 14px;\">" + data.response.biographies[2].text + "</p>");
		}
}
